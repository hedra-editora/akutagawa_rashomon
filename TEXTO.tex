...
\chapter{Memorando «Ryôsai Ogata»}\markboth{Memorando\ldots}{}
...
inspiração, pedi a Donshû que a pusesse por escrito. Apreciem, por favor, este poema:\textit{Doente em viagem},
/\textit{Peregrinam sonhos meus}/ \textit{Por uma terra morta}''.}{\textsc{diário de hanaya}\footnotemark}\footnotetext{ \textit{Diário de Hanaya} é a coletânea de impressões, diálogos
...
absorção; estado perfeito de concentração espiritual.}}\markboth{Devoção\ldots}{}
...
\chapter{Passagens do caderno de notas de Yasukichi}\markboth{Passagens\ldots}{}
...
medir a ele. Mas compondo poemas líricos --- como ``A mulher do Norte''\footnote{Em geral, refere"-se à ``mulher
