...
\hspace{1.2em}\textit{Por uma terra morta}''.}{\textsc{diário de hanaya}\footnotemark}\footnotetext{ \textit{Diário de Hanaya} é a coletânea de impressões, diálogos
...
\hspace{\fill}20 de junho de 1927
\hspace{\fill}Ryûnosuke Akutagawa
...
\paragraph{13. A morte do mestre}
...
\paragraph{19. As asas artificiais}
...
\paragraph{21. A filha de uma louca}
...
\paragraph{27. A disciplina espartana}
...
\paragraph{31. O grande terremoto\footnotemark}
...
\paragraph{37. A mulher do norte\footnotemark}

\footnotemark{ Em geral, refere"-se à ``mulher
...
\paragraph{42. O riso dos deuses}
...
\paragraph{49. O cisne empalhado}
