...
Era num entardecer. Um servo de baixa condição esperava, sob o
...
\chapter{Memorando «Ryôsai Ogata»}

Tendo em vista que, ultimamente, em nossa aldeia, um bando de adeptos da
...
Terá sido na era Genna? Ou na era Kan'ei?\footnote{ Trata-se de divisões
...
Ainda que vivamos trezentos anos e nos saciemos de todos os prazeres,
que será tudo, se não um sonho efêmero, em comparação com este júbilo
eterno?{\textsc{guia do pecador}\\ (Fragmento de uma tradução feita na era
Keichô)}
\footnote{ Era Keichô: período histórico japonês, de 1596 a 1615.}

Aqueles que entrarem no caminho do Bem conhecerão a indizível doçura
da Santa Doutrina.{\textsc{imitatione christi}\\ (Fragmento de uma tradução feita na
era Keichô)}

\section{i}

Havia naquela época, numa \textit{Ekereshiya} [igreja] chamada Santa
...
Convocando Jôsô e Kyorai, disse o mestre: ``Ontem à noite, insone, tomado por uma súbita
inspiração, pedi a Donshû que a pusesse por escrito. Apreciem, por favor, este poema:
\smallskip

\hspace{1.2em}\textit{Doente em viagem},\\
\hspace{1.2em}\textit{Peregrinam sonhos meus}\\
\hspace{1.2em}\textit{Por uma terra morta}''.\textsc{diário de hanaya}\footnote{ \textit{Diário de Hanaya} é a coletânea de impressões, diálogos
...
Era pela tarde do dia doze do décimo mês lunar do ano sete da era
...
\chapter{Devoção à literatura popular\footnote{ \textit{Gesaku zanmai}
...
Era uma manhã do nono mês lunar do ano dois da 
...
Foi na noite de três de novembro do décimo nono ano da era Meiji (1886).
...
\chapter{Passagens do caderno de notas de Yasukichi}

\section{au!}

Certo fim de tarde de inverno, no primeiro andar de um restaurante um
...
\section{[19] As asas artificiais}
...
\section{[21] A filha de uma louca}
...
\section{[27] A disciplina espartana}
...
\section{[31] O grande terremoto}\footnote{ Trata-se do Grande Terremoto
...
\section{[37] A mulher do Norte\footnote{Em geral, refere-se à ``mulher
