\title{Rashômon e outros contos}

\author{Ryûnosuke Akutagawa}

Madalena Hashimoto Cordaro e Junko Ota (\textit{organização e tradução})
...
\textbf{tradução©}                      {Madalena Hashimoto Cordaro e Junko Ota}
\textbf{organização©}                   {Madalena Hashimoto Cordaro e Junko Ota}

\textbf{primeira edição}               {\textit{Rashômon e outras histórias} (Paulicéia, 1992)}
...
\textbf{\textsc{isbn}}                  {978-65-89705-59-8}
...
\chapter{Introdução\subtitulo{A feiura do egoísmo humano e o valor da arte}}
\addcontentsline{toc}{chapter}{Introdução, \textit{por Madalena Hashimoto Cordaro}}
...
\textsc{â, ê, î, ô, û} são vogais longas. O acento circunflexo sobre as vogais indica que sua pronúncia é alongada. \textit{Rashômon} lê"-se \textit{Ra"-xo"-o-mo"-n}.

\textsc{ya, yo, yu} são encontros vocálicos mais breves que \textit{ia}, \textit{io}, \textit{iu}.

\textsc{ha, he, hi, ho} o \textit{h} dessas sílabas é sempre aspirado.

\textsc{cha, che, chi, cho, chu} leem"-se, respectivamente, \textit{tcha}, \textit{tche}, \textit{tchi}, \textit{tcho}, \textit{tchu}.

\textsc{ge, gi} leem"-se gue, gui. \textit{Ogin} lê"-se \textit{Oguin}.

\textsc{ra, re, ri, ro, ru} trata"-se de \textit{r} brando, mesmo em início de vocábulo. O \textit{ra} de \textit{Rashômon} pronuncia"-se como o \textit{ra} de \textit{cera}

\textsc{sa, se, so, su} intervocálicos leem"-se \textit{ça}, \textit{ce}, \textit{ço}, \textit{çu}. \textit{Gesaku} lê"-se \textit{guessaku}.

\textsc{n} trata"-se de sílaba e não de nasalização de sons anteriores ou posteriores. \textit{Rashômon} lê"-se \textit{Ra"-xo"-o-mo"-n}.

\textsc{consoantes dobradas} correspondem a ligeira suspensão da sílaba. \textit{Kappa} lê"-se \textit{ka\,{[}suspensão breve{]}\,pa}.
...
lugar ermo, onde cedros finos se misturam aos bambus.m
...
--- Então, leve"-me para onde você for. (\textit{Longo silêncio}.)
...
\begin{epigraphs} 
\qitem{Ainda que vivamos trezentos anos e nos saciemos de todos os prazeres,
que será tudo, se não um sonho efêmero, em comparação com este júbilo
eterno?}{\textsc{guia do pecador}\\\textit{Fragmento de uma tradução\\feita na era
Keichô}}%\footnotemark}
%\footnotetext{Era Keichô é um período histórico japonês, de 1596 a 1615.}

\bigskip

\qitem{Aqueles que entrarem no caminho do Bem conhecerão a indizível doçura
da Santa Doutrina.}{\textsc{imitatione christi}\\\textit{Fragmento de uma tradução\\feita na
era Keichô}}
\end{epigraphs}
...
\footnotetext{\textit{Diário de Hanaya} é a coletânea de impressões, diálogos e cartas referentes às viagens, ao adoecimento e à morte de Bashô, escritas por
seus discípulos. \textit{Jôsô Naitô} (1662--1704), tal como certos nomes
citados na obra (como Kyorai, Kikaku, Shikô), é um dos dez principais discípulos de
...
Bashô. \textit{Donshû} é um haicaísta de Ôsaka.}
...
``absorção''; ``estado perfeito de concentração espiritual''.}}\markboth{Devoção à literatura\ldots}{}
...
Assim dizendo, com o olhar Ichibei \textit{acariciou} (foi com essa palavra que
...
\chapter[Passagens do caderno de notas de Yasukichi]{Passagens do caderno de\break notas de Yasukichi\footnote{Abril de 1923.}}\markboth{Passagens do caderno\ldots}{}
...
--- Diga \textit{au}! Não vai dizer \textit{au}? --- lançou de novo o oficial responsável.
...
\chapter{A vida de um idiota\footnote{Junho de 1927.}\footnote{Como se vê, esta não é uma obra de ficção. Akutagawa se matou com uma dose excessiva de Veronal, um mês
...
\footnotetext{ Trata"-se do Grande Terremoto
