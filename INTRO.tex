\chapter*{Introdução\smallskip\subtitulo{A feiura do egoísmo humano\break e o valor da arte}}
...
\noindent\textit{Tendências do Novo Pensamento} ou \textit{Shinshichô} é uma
...
Dragão (\textit{tatsu} ou \textit{ryû}), Akutagawa cresceu na \textit{cidade
...
Akutagawa é considerado parte do grupo de intelectuais e estetas contrários ao naturalismo (que engendrou grande número de obras no Japão), ao humanismo de cunho social de Shirakaba (seus membros em geral provinham de elite econômica) e à literatura proletária (que se manteve bem restrita quanto à forma). Jun'ichirô Tanizaki  (1886--1965), Haruo Satô  (1892--1964) e Mantarô Kubota  (1889--1963) foram companheiros
...
\textit{Rashômon}, de 1915, e \textit{Yabuno naka} ou \textit{Dentro do bosque}, de 1922, 
...
de prosa de modelos importados quanto de poesia autóctone.\looseness=-1
