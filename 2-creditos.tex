...
\textbf{tradução©}\quad			 			 {Madalena Hashimoto Cordaro e Junko Ota}\\
\textbf{organização©}\quad			 		 {Madalena Hashimoto Cordaro e Junko Ota}\\
%\textbf{posfácio©}\quad			 		 {}\\
%\textbf{ilustração©}\quad			 		 {copyrightilustracao}\medskip

%\textbf{título original}\quad			 	 {}\\
%\textbf{edição consultada}\quad			 {edicaoconsultada}\\
\textbf{primeira edição}\quad			 	 {\textit{Rashômon e outras histórias} (Paulicéia, 1992)}\\
...
\textbf{\textsc{isbn}}\quad			 		 {978-65-89705-59-8}
